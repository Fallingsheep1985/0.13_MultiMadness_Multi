...
_role3 = "RULES/HELP";
_role3names = ["press INSERT to open help/rules","press J to open your journal","press right CTRL for group management"];
_role4 = "Server Mods - #1"; 
_role4names = ["Base Building 1.3","Admin Tools","Burn Tents","Debug Monitor","Take clothes"];
_role5 = "Server Mods - #2";
_role5names = ["Tent healing", "Zombie Bait", "Zombie Bomb","Suicide","DZAI","Snap build pro"];
_role6 = "Server Mods - #3";
_role6names = ["DZMS", "Burn Tents", "Drink Water", "Fast Roping", "Heli Lift", "Towing"];
